...
from NixaRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from NixaRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from NixaRobot.modules.sql import disable_sql as sql
