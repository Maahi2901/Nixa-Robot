...
from NixaRobot.modules import ALL_MODULES
from NixaRobot.modules.helper_funcs.chat_status import is_user_admin
from NixaRobot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
ʜᴇʟʟᴏ [❣️](https://telegra.ph/file/68465fc62268edcecc71d.jpg), ɪ ᴀᴍ ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴏꜰ ᴛᴇʟᴇɢʀᴀᴍ.
...
NIXA_IMG = "https://telegra.ph/file/68465fc62268edcecc71d.jpg"
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5576613955 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "ɴɪxᴀ ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ 😂\n\nᴍᴀᴅᴇ ᴡɪᴛʜ ʙʏ sᴜᴍɪᴛ ʏᴀᴅᴀᴠ")
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(nixa_about_callback, pattern=r"nixa_")
